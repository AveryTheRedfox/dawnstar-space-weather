...
async function FetchAll() {
    try {
        const [windResponse, imfResponse, kpResponse, alertsResponse, flareResponse, latestFlareResponse] = await Promise.all([
        ...
        const [windResult, imfResult, kpResult, alertsResult, flareResult, latestFlareResult] = await Promise.all([
            windResponse.json(),
            imfResponse.json(),
            kpResponse.json(),
            alertsResponse.json(),
